        ...
        return (
            <div>
                <form>
                    ...
                    <button id="addConstituency" className="btn btn-xs btn-success" onClick={this.props.onAddClick}>Pridėti</button>
                    <button id="cancelConstituency" className="btn btn-xs btn-danger" onClick={this.props.onCancel}>Atšaukti</button>
                </form>
