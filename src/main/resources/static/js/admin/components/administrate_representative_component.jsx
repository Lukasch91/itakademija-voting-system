        ...
        return (
            <div>
                <form>
                    ...
                    <button id="generatePassword" className="btn btn-xs btn-warning" onClick={this.props.onGeneratePass} disabled={disabled}>Generuoti slaptažodį</button><br /><br />                    
                    ...
                    <button id="addRepresentative" className="btn btn-xs btn-success" onClick={this.props.onAddRepresentative}>Pridėti</button>
                    <button id="cancelRepresentative" className="btn btn-xs btn-danger" onClick={this.props.onCancel} >Atšaukti</button>
                </form>
