...
public class DownloadResultsService {
	...
	public String request4() {
		...
		tableData.add(request4Header());
		for (MultiElectionResultsAll sERA : all) {
			tableData.add(request4ToStringArray(sERA));
		}
	...
	public String request3() {
		...
		List<String[]> tableData = new ArrayList<String[]>();
		tableData.add(request3Header());
		for (SingleElectionResultsAll sERA : all) {
			tableData.add(request3ToStringArray(sERA));
		}
		String result = listArrayToCSVSting(tableData);
		log.info("||--> Finished!" );
		return result;
	...
	public String request2() {
		...
		List<String[]> tableData = new ArrayList<String[]>();
		tableData.add(request2Header());
		for (SingleElectionResultsAll sERA : all) {
			tableData.add(request2ToStringArray(sERA));
		}
		String result = listArrayToCSVSting(tableData);
		log.info("||--> Finished!" );
		return result;
	...
	private String request1() {
		...
		for (SingleElectionConstituency sEC : singleConstituencyResultsList) {
			tableData.add(request1ToStringArray(sEC));
		}
	...
	private List<String[]> dataLimiter(List<String[]> listToLimit , int[] columnsToRemove) {
		
		for(String[] row : listToLimit) {	
		}
...
//				"Partijos mandatai"
	...
	public String[] request4ToStringArray(MultiElectionResultsAll multiElectionResultsAll) {
		log.info("||--> was used." );
		return new String[] { 
				/* constituency */
...
//				multiElectionResultsAll.getResNumberOfMandates().toString()
	...
	public String[] request3ToStringArray(SingleElectionResultsAll singleElectionResultsAll) {
		log.info("||--> was used." );
		return new String[] { 
				/* constituency */
	...
	public String[] request2ToStringArray(SingleElectionResultsAll singleElectionResultsAll) {
		log.info("||--> was used." );
	...
	public String[] request1ToStringArray(SingleElectionConstituency singleConstituencyResult) {
		log.info("||--> was used." );
